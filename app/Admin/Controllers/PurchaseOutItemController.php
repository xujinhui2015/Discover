...
use App\Admin\Repositories\PurchaseOutItem;
use Dcat\Admin\Form;
use Dcat\Admin\Grid;
use Dcat\Admin\Controllers\AdminController;

class PurchaseOutItemController extends AdminController
{
    /**
     * Make a grid builder.
     *
    ...
    {
        return Grid::make(new PurchaseOutItem(), function (Grid $grid) {
            $columnConfig = [
                ['name' => 'id', 'label' => 'ID'],
                ['name' => 'order_id', 'label' => '订单ID'],
                ['name' => 'sku_id', 'label' => 'SKU ID'],
                ['name' => 'should_num', 'label' => '应出数量'],
                ['name' => 'actual_num', 'label' => '实出数量'],
                ['name' => 'price', 'label' => '价格'],
    ...
    {
        return Form::make(new PurchaseOutItem(), function (Form $form) {
            $form->display('id');
