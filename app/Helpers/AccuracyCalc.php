...
class AccuracyCalc
{
     ...
     * 通过静态调用方法
     */
    public static function begin(string|int|float|null $result, int $scale = 2): AccuracyCalc
    {
    ...
    {
        $this->result = bcmul($this->result, bcdiv((string)$proportion ?? '0', '100', $this->scale), $this->scale);
        return $this;
    }
