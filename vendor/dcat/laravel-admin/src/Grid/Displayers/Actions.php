...
//EOF;
        return <<<EOF
<a title="{$label}" style="padding: 3px 8px; border-radius: 3px; display: inline-flex; align-items: center; cursor: pointer; transition: all 0.2s ease;" class="{$this->grid->getRowName()}-edit btn btn-xs btn-primary" data-url="{$this->resource()}/{$this->getKey()}/edit" href="javascript:void(0);">
    操作
</a>&nbsp;
EOF;
    }
